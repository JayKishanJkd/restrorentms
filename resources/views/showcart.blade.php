...
-->
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <li><a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 
    ...
    <table align="center" bgcolor="yellow">
        ...
        <th><a href="{{url('/remove',$data2->id)}}" style="text-decoration-line: none" class="btn btn-warning">Remove</a></th>
        </tr>   
        @endforeach
    </table>
